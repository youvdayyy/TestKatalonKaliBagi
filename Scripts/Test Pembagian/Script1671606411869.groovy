...
txtResult = Mobile.getText(findTestObject('Object Repository/android.widget.TextView - 2'), 0)

Mobile.verifyElementText(findTestObject('android.widget.TextView - 2'), txtResult)
