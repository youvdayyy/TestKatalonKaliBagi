...
txtResult = Mobile.getText(findTestObject('Object Repository/android.widget.TextView - 10'), 0)

Mobile.verifyElementText(findTestObject('android.widget.TextView - 10'), txtResult)
